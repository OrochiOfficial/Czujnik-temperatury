...
void loop() {
  ...
  Serial.print(" stopni szmatanika");
  Serial.print("\t\t");
  Serial.println();
}
...
void handleRoot() {
  ...
  webpage += "<h2> Tomasz Kotyla, Jakub Palazej</h2> ";
  webpage += "<p>Temperatura: " + String(temperature, 1) + " stopni szmatanika</p>";
